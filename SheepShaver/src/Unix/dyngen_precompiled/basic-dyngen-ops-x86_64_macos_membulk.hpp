/* Generated by patch_jit_membulk.py from /var/folders/tj/ss_whxv92157_nsy2ddc75pr0000gn/T/tmpywwav9v1/basic-dyngen-ops-x86_64_macos.hpp.
...
#define HAVE_gen_op_load_u8_T0_T1_0
{
    ...
    copy_block(op_load_u8_T0_T1_0_code, 63);
...
#define HAVE_gen_op_store_8_T0_T1_0
{
    ...
    copy_block(op_store_8_T0_T1_0_code, 62);
    *(uint64_t *)(code_ptr() + 30) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 47) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(62);
}
...
#define HAVE_gen_op_load_s16_T0_T1_0
{
    ...
    copy_block(op_load_s16_T0_T1_0_code, 70);
    *(uint64_t *)(code_ptr() + 30) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 47) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(70);
}
...
#define HAVE_gen_op_load_s32_T0_T1_0
{
    ...
    copy_block(op_load_s32_T0_T1_0_code, 67);
    *(uint64_t *)(code_ptr() + 30) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 47) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(67);
}
...
#define HAVE_gen_op_load_u16_T0_T1_0
{
    ...
    copy_block(op_load_u16_T0_T1_0_code, 70);
    *(uint64_t *)(code_ptr() + 30) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 47) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(70);
}
...
#define HAVE_gen_op_load_u32_T0_T1_0
{
    ...
    copy_block(op_load_u32_T0_T1_0_code, 67);
    *(uint64_t *)(code_ptr() + 30) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 47) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(67);
}
...
#define HAVE_gen_op_load_u8_T0_T1_T2
{
    ...
    copy_block(op_load_u8_T0_T1_T2_code, 64);
...
#define HAVE_gen_op_load_u8_T0_T1_im
{
    ...
    copy_block(op_load_u8_T0_T1_im_code, 72);
...
#define HAVE_gen_op_store_16_T0_T1_0
{
    ...
    copy_block(op_store_16_T0_T1_0_code, 70);
...
#define HAVE_gen_op_store_32_T0_T1_0
{
    ...
    copy_block(op_store_32_T0_T1_0_code, 66);
...
#define HAVE_gen_op_store_8_T0_T1_T2
{
    ...
    copy_block(op_store_8_T0_T1_T2_code, 63);
    *(uint64_t *)(code_ptr() + 31) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 48) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(63);
}
...
#define HAVE_gen_op_store_8_T0_T1_im
{
    ...
    copy_block(op_store_8_T0_T1_im_code, 71);
    *(uint64_t *)(code_ptr() + 39) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 56) = (uint64_t)(uintptr)gKernelData;
    *(uint32_t *)(code_ptr() + 6) = (int32_t)((long)param1 - (long)(code_ptr() + 6 + 4)) + 0;
    inc_code_ptr(71);
...
#define HAVE_gen_op_load_s16_T0_T1_T2
{
    ...
    copy_block(op_load_s16_T0_T1_T2_code, 71);
    *(uint64_t *)(code_ptr() + 31) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 48) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(71);
}
...
#define HAVE_gen_op_load_s16_T0_T1_im
{
    ...
    copy_block(op_load_s16_T0_T1_im_code, 79);
    *(uint64_t *)(code_ptr() + 39) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 56) = (uint64_t)(uintptr)gKernelData;
    *(uint32_t *)(code_ptr() + 6) = (int32_t)((long)param1 - (long)(code_ptr() + 6 + 4)) + 0;
    inc_code_ptr(79);
...
#define HAVE_gen_op_load_s32_T0_T1_T2
{
    ...
    copy_block(op_load_s32_T0_T1_T2_code, 68);
    *(uint64_t *)(code_ptr() + 31) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 48) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(68);
}
...
#define HAVE_gen_op_load_s32_T0_T1_im
{
    ...
    copy_block(op_load_s32_T0_T1_im_code, 76);
    *(uint64_t *)(code_ptr() + 39) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 56) = (uint64_t)(uintptr)gKernelData;
    *(uint32_t *)(code_ptr() + 6) = (int32_t)((long)param1 - (long)(code_ptr() + 6 + 4)) + 0;
    inc_code_ptr(76);
...
#define HAVE_gen_op_load_u16_T0_T1_T2
{
    ...
    copy_block(op_load_u16_T0_T1_T2_code, 71);
    *(uint64_t *)(code_ptr() + 31) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 48) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(71);
}
...
#define HAVE_gen_op_load_u16_T0_T1_im
{
    ...
    copy_block(op_load_u16_T0_T1_im_code, 79);
    *(uint64_t *)(code_ptr() + 39) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 56) = (uint64_t)(uintptr)gKernelData;
    *(uint32_t *)(code_ptr() + 6) = (int32_t)((long)param1 - (long)(code_ptr() + 6 + 4)) + 0;
    inc_code_ptr(79);
...
#define HAVE_gen_op_load_u32_T0_T1_T2
{
    ...
    copy_block(op_load_u32_T0_T1_T2_code, 68);
    *(uint64_t *)(code_ptr() + 31) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 48) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(68);
}
...
#define HAVE_gen_op_load_u32_T0_T1_im
{
    ...
    copy_block(op_load_u32_T0_T1_im_code, 76);
    *(uint64_t *)(code_ptr() + 39) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 56) = (uint64_t)(uintptr)gKernelData;
    *(uint32_t *)(code_ptr() + 6) = (int32_t)((long)param1 - (long)(code_ptr() + 6 + 4)) + 0;
    inc_code_ptr(76);
...
#define HAVE_gen_op_store_16_T0_T1_T2
{
    ...
    copy_block(op_store_16_T0_T1_T2_code, 71);
...
#define HAVE_gen_op_store_16_T0_T1_im
{
    ...
    copy_block(op_store_16_T0_T1_im_code, 78);
    *(uint64_t *)(code_ptr() + 46) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 63) = (uint64_t)(uintptr)gKernelData;
...
#define HAVE_gen_op_store_32_T0_T1_T2
{
    ...
    copy_block(op_store_32_T0_T1_T2_code, 70);
    *(uint64_t *)(code_ptr() + 38) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 56) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(70);
}
...
#define HAVE_gen_op_store_32_T0_T1_im
{
    ...
    copy_block(op_store_32_T0_T1_im_code, 75);
