/* Generated by patch_jit_membulk.py from /var/folders/tj/ss_whxv92157_nsy2ddc75pr0000gn/T/tmpywwav9v1/ppc-dyngen-ops-x86_64_macos.hpp.
...
#define TRANS_RAX \
	0x51,0x89,0xC1,0x81,0xE1,0x00,0xC0,0xFF,0xFF,0x81,0xF9,0x00,\
	0xC0,0xFF,0x68,0x74,0x14,0x81,0xF9,0x00,0xC0,0xFF,0x5F,0x74,\
	0x0C,0x48,0xB9,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xEB,\
	0x0F,0x25,0xFF,0x3F,0x00,0x00,0x48,0xB9,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x48,0x01,0xC8,0x59

#define TRANS_RDX \
	0x51,0x89,0xD1,0x81,0xE1,0x00,0xC0,0xFF,0xFF,0x81,0xF9,0x00,\
	0xC0,0xFF,0x68,0x74,0x14,0x81,0xF9,0x00,0xC0,0xFF,0x5F,0x74,\
	0x0C,0x48,0xB9,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xEB,\
	0x10,0x81,0xE2,0xFF,0x3F,0x00,0x00,0x48,0xB9,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x48,0x01,0xCA,0x59
...
#define HAVE_gen_op_dcbz_T0
{
    ...
    copy_block(op_dcbz_T0_code, 98);
    *(uint64_t *)(code_ptr() + 38) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 55) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(98);
}
#endif
...
#define HAVE_gen_op_lmw_T0_26
{
    static const uint8 op_lmw_T0_26_code[] = {
       0x44, 0x89, 0xe2, 0x44, 0x89, 0xe0, 
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x45, 0x78, 0x8d, 0x42, 0x04, 0x41, 0x89, 0xc4, 0x89,
       0xc0, 
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x45, 0x7c, 0x8d, 0x42, 0x08, 0x41, 0x89, 0xc4, 0x89,
       0xc0, 
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x85, 0x80, 0x00, 0x00, 0x00, 0x8d, 0x42, 0x0c, 0x41,
       0x89, 0xc4, 0x89, 0xc0, 
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x85, 0x84, 0x00, 0x00, 0x00, 0x8d, 0x42, 0x10, 0x41,
       0x89, 0xc4, 0x89, 0xc0, 
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x85, 0x88, 0x00, 0x00, 0x00, 0x83, 0xc2, 0x14, 0x41,
       0x89, 0xd4, 0x89, 0xd2, 
       TRANS_RDX,
       0x8b, 0x02, 
       0x0f, 0xc8, 0x89, 0x85, 0x8c, 0x00, 0x00, 0x00
    };
    copy_block(op_lmw_T0_26_code, 437);
    *(uint64_t *)(code_ptr() + 33) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 50) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 104) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 121) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 175) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 192) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 249) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 266) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 323) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 340) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 397) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 415) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(437);
}
#endif
...
#define HAVE_gen_op_lmw_T0_27
{
    static const uint8 op_lmw_T0_27_code[] = {
       ...
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x45, 0x7c, 0x8d, 0x42, 0x04, 0x41, 0x89, 0xc4, 0x89,
       0xc0, 
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x85, 0x80, 0x00, 0x00, 0x00, 0x8d, 0x42, 0x08, 0x41,
       0x89, 0xc4, 0x89, 0xc0, 
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x85, 0x84, 0x00, 0x00, 0x00, 0x8d, 0x42, 0x0c, 0x41,
       0x89, 0xc4, 0x89, 0xc0, 
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x85, 0x88, 0x00, 0x00, 0x00, 0x83, 0xc2, 0x10, 0x41,
       0x89, 0xd4, 0x89, 0xd2, 
       TRANS_RDX,
       0x8b, 0x02, 
       0x0f, 0xc8, 0x89, 0x85, 0x8c, 0x00, 0x00, 0x00
    };
    copy_block(op_lmw_T0_27_code, 366);
    *(uint64_t *)(code_ptr() + 33) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 50) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 104) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 121) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 178) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 195) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 252) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 269) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 326) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 344) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(366);
}
#endif
...
#define HAVE_gen_op_lmw_T0_28
{
    static const uint8 op_lmw_T0_28_code[] = {
       ...
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x85, 0x80, 0x00, 0x00, 0x00, 0x8d, 0x42, 0x04, 0x41,
       0x89, 0xc4, 0x89, 0xc0, 
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x85, 0x84, 0x00, 0x00, 0x00, 0x8d, 0x42, 0x08, 0x41,
       0x89, 0xc4, 0x89, 0xc0, 
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x85, 0x88, 0x00, 0x00, 0x00, 0x83, 0xc2, 0x0c, 0x41,
       0x89, 0xd4, 0x89, 0xd2, 
       TRANS_RDX,
       0x8b, 0x02, 
       0x0f, 0xc8, 0x89, 0x85, 0x8c, 0x00, 0x00, 0x00
    };
    copy_block(op_lmw_T0_28_code, 295);
    *(uint64_t *)(code_ptr() + 33) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 50) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 107) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 124) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 181) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 198) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 255) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 273) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(295);
}
#endif
...
#define HAVE_gen_op_lmw_T0_29
{
    static const uint8 op_lmw_T0_29_code[] = {
       ...
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x85, 0x84, 0x00, 0x00, 0x00, 0x8d, 0x42, 0x04, 0x41,
       0x89, 0xc4, 0x89, 0xc0, 
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x85, 0x88, 0x00, 0x00, 0x00, 0x83, 0xc2, 0x08, 0x41,
       0x89, 0xd4, 0x89, 0xd2, 
       TRANS_RDX,
       0x8b, 0x02, 
       0x0f, 0xc8, 0x89, 0x85, 0x8c, 0x00, 0x00, 0x00
    };
    copy_block(op_lmw_T0_29_code, 221);
    *(uint64_t *)(code_ptr() + 33) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 50) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 107) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 124) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 181) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 199) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(221);
}
#endif
...
#define HAVE_gen_op_lmw_T0_30
{
    static const uint8 op_lmw_T0_30_code[] = {
       ...
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x89, 0x85, 0x88, 0x00, 0x00, 0x00, 0x83, 0xc2, 0x04, 0x41,
       0x89, 0xd4, 0x89, 0xd2, 
       TRANS_RDX,
       0x8b, 0x02, 
       0x0f, 0xc8, 0x89, 0x85, 0x8c, 0x00, 0x00, 0x00
    };
    copy_block(op_lmw_T0_30_code, 147);
    *(uint64_t *)(code_ptr() + 33) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 50) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 107) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 125) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(147);
}
#endif
...
#define HAVE_gen_op_lmw_T0_31
{
    ...
    copy_block(op_lmw_T0_31_code, 69);
    *(uint64_t *)(code_ptr() + 30) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 47) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(69);
}
#endif
...
#define HAVE_gen_op_lmw_T0_im
{
    static const uint8 op_lmw_T0_im_code[] = {
       ...
       0x10, 0xeb, 0x49, 0x89, 0xc8, 
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x48, 0x63, 0xd6, 0x89, 0x04, 0x97, 0xff, 0xc6, 0x83, 0xc1,
       0x04, 0x83, 0xfe, 0x1f, 0x76, 0xb2
    };
    copy_block(op_lmw_T0_im_code, 93);
    *(uint64_t *)(code_ptr() + 44) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 61) = (uint64_t)(uintptr)gKernelData;
...
#define HAVE_gen_op_fabs_FD_F0
{
    static const uint8 op_fabs_FD_F0_code[] = {
       ...
       0xff, 0x7f, 0x48, 0x21, 0xd0, 0x48, 0x89, 0x85, 0x00, 0x00, 0x00, 0x00,
    };
    copy_block(op_fabs_FD_F0_code, 24);
    *(uint32_t *)(code_ptr() + 20) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(24);
}
#endif
...
#define HAVE_gen_op_fmov_FD_F0
{
    static const uint8 op_fmov_FD_F0_code[] = {
       0x49, 0x8b, 0x04, 0x24, 0x48, 0x89, 0x85, 0x00, 0x00, 0x00, 0x00
    };
    copy_block(op_fmov_FD_F0_code, 11);
    *(uint32_t *)(code_ptr() + 7) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(11);
}
#endif
...
#define HAVE_gen_op_fmov_FD_F1
{
    static const uint8 op_fmov_FD_F1_code[] = {
       0x49, 0x8b, 0x45, 0x00, 0x48, 0x89, 0x85, 0x00, 0x00, 0x00, 0x00
    };
...
#define HAVE_gen_op_fmov_FD_F2
{
    static const uint8 op_fmov_FD_F2_code[] = {
       0x49, 0x8b, 0x06, 0x48, 0x89, 0x85, 0x00, 0x00, 0x00, 0x00
    };
    copy_block(op_fmov_FD_F2_code, 10);
    *(uint32_t *)(code_ptr() + 6) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(10);
}
#endif
...
#define HAVE_gen_op_fneg_FD_F0
{
    static const uint8 op_fneg_FD_F0_code[] = {
       ...
       0x00, 0x80, 0x48, 0x31, 0xc8, 0x48, 0x89, 0x85, 0x00, 0x00, 0x00, 0x00,
    };
...
#define HAVE_gen_op_stmw_T0_26
{
    static const uint8 op_stmw_T0_26_code[] = {
       0x8b, 0x45, 0x78, 0x0f, 0xc8, 0x44, 0x89, 0xe2, 
       TRANS_RDX,
       0x89, 0x02, 
       0x41, 0x8d, 0x54, 0x24, 0x04, 0x41, 0x89, 0xd4, 0x8b, 0x45, 0x7c, 0x0f,
       0xc8, 0x89, 0xd2, 
       TRANS_RDX,
       0x89, 0x02, 
       0x41, 0x8d, 0x54, 0x24, 0x04, 0x41, 0x89, 0xd4, 0x8b, 0x85, 0x80, 0x00,
       0x00, 0x00, 0x0f, 0xc8, 0x89, 0xd2, 
       TRANS_RDX,
       0x89, 0x02, 
       0x41, 0x8d, 0x54, 0x24, 0x04, 0x41, 0x89, 0xd4, 0x8b, 0x85, 0x84, 0x00,
       0x00, 0x00, 0x0f, 0xc8, 0x89, 0xd2, 
       TRANS_RDX,
       0x89, 0x02, 
       0x41, 0x8d, 0x54, 0x24, 0x04, 0x41, 0x89, 0xd4, 0x8b, 0x85, 0x88, 0x00,
       0x00, 0x00, 0x0f, 0xc8, 0x89, 0xd2, 
       TRANS_RDX,
       0x89, 0x02, 
       0x41, 0x8d, 0x54, 0x24, 0x04, 0x41, 0x89, 0xd4, 0x8b, 0x85, 0x8c, 0x00,
       0x00, 0x00, 0x0f, 0xc8, 0x89, 0xd2, 
       TRANS_RDX,
       0x89, 0x02, 
    };
    copy_block(op_stmw_T0_26_code, 449);
    *(uint64_t *)(code_ptr() + 35) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 53) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 109) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 127) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 186) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 204) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 263) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 281) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 340) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 358) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 417) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 435) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(449);
}
#endif
...
#define HAVE_gen_op_stmw_T0_27
{
    static const uint8 op_stmw_T0_27_code[] = {
       0x8b, 0x45, 0x7c, 0x0f, 0xc8, 0x44, 0x89, 0xe2, 
       TRANS_RDX,
       0x89, 0x02, 
       0x41, 0x8d, 0x54, 0x24, 0x04, 0x41, 0x89, 0xd4, 0x8b, 0x85, 0x80, 0x00,
       0x00, 0x00, 0x0f, 0xc8, 0x89, 0xd2, 
    ...
    copy_block(op_stmw_T0_27_code, 375);
    *(uint64_t *)(code_ptr() + 35) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 53) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 112) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 130) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 189) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 207) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 266) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 284) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 343) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 361) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(375);
}
#endif
...
#define HAVE_gen_op_stmw_T0_28
{
    static const uint8 op_stmw_T0_28_code[] = {
       0x8b, 0x85, 0x80, 0x00, 0x00, 0x00, 0x0f, 0xc8, 0x44, 0x89, 0xe2, 
       TRANS_RDX,
       0x89, 0x02, 
       0x41, 0x8d, 0x54, 0x24, 0x04, 0x41, 0x89, 0xd4, 0x8b, 0x85, 0x84, 0x00,
       0x00, 0x00, 0x0f, 0xc8, 0x89, 0xd2, 
    ...
    copy_block(op_stmw_T0_28_code, 301);
    *(uint64_t *)(code_ptr() + 38) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 56) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 115) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 133) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 192) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 210) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 269) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 287) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(301);
}
#endif
...
#define HAVE_gen_op_stmw_T0_29
{
    static const uint8 op_stmw_T0_29_code[] = {
       0x8b, 0x85, 0x84, 0x00, 0x00, 0x00, 0x0f, 0xc8, 0x44, 0x89, 0xe2, 
       TRANS_RDX,
       0x89, 0x02, 
       0x41, 0x8d, 0x54, 0x24, 0x04, 0x41, 0x89, 0xd4, 0x8b, 0x85, 0x88, 0x00,
       0x00, 0x00, 0x0f, 0xc8, 0x89, 0xd2, 
    ...
    copy_block(op_stmw_T0_29_code, 224);
    *(uint64_t *)(code_ptr() + 38) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 56) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 115) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 133) = (uint64_t)(uintptr)gKernelData;
...
#define HAVE_gen_op_stmw_T0_30
{
    static const uint8 op_stmw_T0_30_code[] = {
       0x8b, 0x85, 0x88, 0x00, 0x00, 0x00, 0x0f, 0xc8, 0x44, 0x89, 0xe2, 
       TRANS_RDX,
       0x89, 0x02, 
       0x41, 0x8d, 0x54, 0x24, 0x04, 0x41, 0x89, 0xd4, 0x8b, 0x85, 0x8c, 0x00,
       0x00, 0x00, 0x0f, 0xc8, 0x89, 0xd2, 
    ...
    copy_block(op_stmw_T0_30_code, 147);
    *(uint64_t *)(code_ptr() + 38) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 56) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 115) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 133) = (uint64_t)(uintptr)gKernelData;
...
#define HAVE_gen_op_stmw_T0_31
{
    static const uint8 op_stmw_T0_31_code[] = {
       0x8b, 0x85, 0x8c, 0x00, 0x00, 0x00, 0x0f, 0xc8, 0x44, 0x89, 0xe2, 
       TRANS_RDX,
       0x89, 0x02, 
    };
    copy_block(op_stmw_T0_31_code, 70);
    *(uint64_t *)(code_ptr() + 38) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 56) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(70);
}
...
#define HAVE_gen_op_stmw_T0_im
{
    static const uint8 op_stmw_T0_im_code[] = {
       0x8d, 0x35, 0x00, 0x00, 0x00, 0x00, 0x44, 0x89, 0xe1, 0xeb, 0x4b, 0x48,
       0x63, 0xc6, 0x8b, 0x44, 0x85, 0x10, 0x0f, 0xc8, 0x89, 0xca, 
       TRANS_RDX,
       0x89, 0x02, 
       0xff, 0xc6, 0x83, 0xc1, 0x04, 0x83, 0xfe, 0x1f, 0x76, 0xb0
    };
    copy_block(op_stmw_T0_im_code, 91);
    *(uint64_t *)(code_ptr() + 49) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 67) = (uint64_t)(uintptr)gKernelData;
    *(uint32_t *)(code_ptr() + 2) = (int32_t)((long)param1 - (long)(code_ptr() + 2 + 4)) + 0;
    inc_code_ptr(91);
}
#endif
...
#define HAVE_gen_op_fnabs_FD_F0
{
    static const uint8 op_fnabs_FD_F0_code[] = {
       ...
       0x00, 0x00, 0x80, 0x48, 0x31, 0xf0, 0x48, 0x89, 0x85, 0x00, 0x00, 0x00,
       0x00
    };
    copy_block(op_fnabs_FD_F0_code, 37);
    *(uint32_t *)(code_ptr() + 33) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(37);
}
#endif
...
#define HAVE_gen_op_lwarx_T0_T1
{
    static const uint8 op_lwarx_T0_T1_code[] = {
       ...
       TRANS_RAX,
       0x8b, 0x00, 
       0x41, 0x89, 0xc4, 0x41, 0x0f, 0xcc, 0x48, 0x89, 0xe8, 0xc7, 0x85, 0xb8,
       0x03, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x44, 0x89, 0xa8, 0xbc, 0x03,
       0x00, 0x00
    };
    copy_block(op_lwarx_T0_T1_code, 87);
    *(uint64_t *)(code_ptr() + 30) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 47) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(87);
}
...
#define HAVE_gen_op_stwcx_T0_T1
{
    static const uint8 op_stwcx_T0_T1_code[] = {
       ...
       0x8b, 0x85, 0xb8, 0x03, 0x00, 0x00, 0x45, 0x85, 0xc0, 0x74, 0x5c, 0xc7,
       0x85, 0xb8, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x8b, 0x85, 0xbc,
       0x03, 0x00, 0x00, 0x44, 0x39, 0xe8, 0x75, 0x47, 0x44, 0x89, 0xe2, 0x0f,
       0xca, 0x89, 0xc0, 
       TRANS_RAX,
       0x89, 0x10, 
       0x81, 0xc9, 0x00, 0x00, 0x00, 0x20, 0x89, 0x8d, 0x90, 0x03, 0x00, 0x00
    };
    copy_block(op_stwcx_T0_T1_code, 133);
    *(uint64_t *)(code_ptr() + 90) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 107) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(133);
}
#endif
...
#define HAVE_gen_op_fadd_FD_F0_F1
{
    ...
    *(uint32_t *)(code_ptr() + 16) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(20);
}
#endif
...
#define HAVE_gen_op_store_FD_FPR0
{
    static const uint8 op_store_FD_FPR0_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x90, 0x00,
       0x00, 0x00
    };
    copy_block(op_store_FD_FPR0_code, 14);
    *(uint32_t *)(code_ptr() + 3) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(14);
}
#endif
...
#define HAVE_gen_op_store_FD_FPR1
{
    static const uint8 op_store_FD_FPR1_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x98, 0x00,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR2
{
    static const uint8 op_store_FD_FPR2_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0xa0, 0x00,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR3
{
    static const uint8 op_store_FD_FPR3_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0xa8, 0x00,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR4
{
    static const uint8 op_store_FD_FPR4_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0xb0, 0x00,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR5
{
    static const uint8 op_store_FD_FPR5_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0xb8, 0x00,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR6
{
    static const uint8 op_store_FD_FPR6_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0xc0, 0x00,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR7
{
    static const uint8 op_store_FD_FPR7_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0xc8, 0x00,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR8
{
    static const uint8 op_store_FD_FPR8_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0xd0, 0x00,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR9
{
    static const uint8 op_store_FD_FPR9_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0xd8, 0x00,
       0x00, 0x00
    };
...
#define HAVE_gen_op_fadds_FD_F0_F1
{
    ...
    *(uint32_t *)(code_ptr() + 24) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(28);
}
#endif
...
#define HAVE_gen_op_store_FD_FPR10
{
    static const uint8 op_store_FD_FPR10_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0xe0, 0x00,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR11
{
    static const uint8 op_store_FD_FPR11_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0xe8, 0x00,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR12
{
    static const uint8 op_store_FD_FPR12_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0xf0, 0x00,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR13
{
    static const uint8 op_store_FD_FPR13_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0xf8, 0x00,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR14
{
    static const uint8 op_store_FD_FPR14_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x00, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR15
{
    static const uint8 op_store_FD_FPR15_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x08, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR16
{
    static const uint8 op_store_FD_FPR16_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x10, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR17
{
    static const uint8 op_store_FD_FPR17_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x18, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR18
{
    static const uint8 op_store_FD_FPR18_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x20, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR19
{
    static const uint8 op_store_FD_FPR19_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x28, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR20
{
    static const uint8 op_store_FD_FPR20_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x30, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR21
{
    static const uint8 op_store_FD_FPR21_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x38, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR22
{
    static const uint8 op_store_FD_FPR22_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x40, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR23
{
    static const uint8 op_store_FD_FPR23_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x48, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR24
{
    static const uint8 op_store_FD_FPR24_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x50, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR25
{
    static const uint8 op_store_FD_FPR25_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x58, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR26
{
    static const uint8 op_store_FD_FPR26_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x60, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR27
{
    static const uint8 op_store_FD_FPR27_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x68, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR28
{
    static const uint8 op_store_FD_FPR28_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x70, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR29
{
    static const uint8 op_store_FD_FPR29_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x78, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR30
{
    static const uint8 op_store_FD_FPR30_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x80, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_store_FD_FPR31
{
    static const uint8 op_store_FD_FPR31_code[] = {
       0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x00, 0x48, 0x89, 0x85, 0x88, 0x01,
       0x00, 0x00
    };
...
#define HAVE_gen_op_load_vect_VD_T0
{
    static const uint8 op_load_vect_VD_T0_code[] = {
       ...
       TRANS_RAX,
       0x8b, 0x00, 
       0x0f, 0xc8, 0x41, 0x89, 0x47, 0x08, 0x83, 0xc2, 0x0c, 0x89, 0xd2, 
       TRANS_RDX,
       0x8b, 0x02, 
       0x0f, 0xc8, 0x41, 0x89, 0x47, 0x0c
    };
    copy_block(op_load_vect_VD_T0_code, 279);
    *(uint64_t *)(code_ptr() + 35) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 52) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 103) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 120) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 172) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 189) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 241) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 259) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(279);
}
#endif
...
#define HAVE_gen_op_load_word_VD_T0
{
    ...
    copy_block(op_load_word_VD_T0_code, 79);
    *(uint64_t *)(code_ptr() + 36) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 53) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(79);
}
#endif
...
#define HAVE_gen_op_store_vect_VD_T0
{
    ...
    copy_block(op_store_vect_VD_T0_code, 280);
    *(uint64_t *)(code_ptr() + 40) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 58) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 110) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 127) = (uint64_t)(uintptr)gKernelData;
    *(uint64_t *)(code_ptr() + 179) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 196) = (uint64_t)(uintptr)gKernelData;
        *(uint64_t *)(code_ptr() + 248) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 266) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(280);
}
#endif
...
#define HAVE_gen_op_store_word_VD_T0
{
    ...
    copy_block(op_store_word_VD_T0_code, 79);
    *(uint64_t *)(code_ptr() + 48) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 65) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(79);
}
#endif
...
#define HAVE_gen_op_fmadd_FD_F0_F1_F2
{
    static const uint8 op_fmadd_FD_F0_F1_F2_code[] = {
       0xf2, 0x41, 0x0f, 0x10, 0x04, 0x24, 0xf2, 0x41, 0x0f, 0x59, 0x45, 0x00,
       0xf2, 0x41, 0x0f, 0x58, 0x06, 0xf2, 0x0f, 0x11, 0x85, 0x00, 0x00, 0x00,
       0x00
    };
    copy_block(op_fmadd_FD_F0_F1_F2_code, 25);
    *(uint32_t *)(code_ptr() + 21) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(25);
}
#endif
...
#define HAVE_gen_op_fmsub_FD_F0_F1_F2
{
    static const uint8 op_fmsub_FD_F0_F1_F2_code[] = {
       0xf2, 0x41, 0x0f, 0x10, 0x04, 0x24, 0xf2, 0x41, 0x0f, 0x59, 0x45, 0x00,
       0xf2, 0x41, 0x0f, 0x5c, 0x06, 0xf2, 0x0f, 0x11, 0x85, 0x00, 0x00, 0x00,
       0x00
    };
...
#define HAVE_gen_op_fmadds_FD_F0_F1_F2
{
    static const uint8 op_fmadds_FD_F0_F1_F2_code[] = {
       ...
       0xc0, 0xf2, 0x0f, 0x11, 0x85, 0x00, 0x00, 0x00, 0x00
    };
    copy_block(op_fmadds_FD_F0_F1_F2_code, 33);
    *(uint32_t *)(code_ptr() + 29) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(33);
}
#endif
...
#define HAVE_gen_op_fnmadd_FD_F0_F1_F2
{
    static const uint8 op_fnmadd_FD_F0_F1_F2_code[] = {
       ...
       0x00, 0xf2, 0x0f, 0x11, 0x85, 0x00, 0x00, 0x00, 0x00
    };
...
#define HAVE_gen_op_fnmadds_FD_F0_F1_F2
{
    ...
    *(uint32_t *)(code_ptr() + 36) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(40);
}
#endif
...
#define HAVE_gen_op_load_double_FD_T1_0
{
    static const uint8 op_load_double_FD_T1_0_code[] = {
       0x44, 0x89, 0xe8, 
       TRANS_RAX,
       0x48, 0x8b, 0x00, 0x48, 0x0f, 0xc8, 0x48, 0x89, 0x85, 0x00, 0x00, 0x00,
       0x00
    };
    copy_block(op_load_double_FD_T1_0_code, 72);
    *(uint64_t *)(code_ptr() + 30) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 47) = (uint64_t)(uintptr)gKernelData;
    *(uint32_t *)(code_ptr() + 68) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(72);
}
#endif
...
#define HAVE_gen_op_load_single_FD_T1_0
{
    static const uint8 op_load_single_FD_T1_0_code[] = {
       0x44, 0x89, 0xe8, 
       TRANS_RAX,
       0x8b, 0x00, 0x0f, 0xc8, 0x89, 0x44, 0x24, 0xf4, 0xf3, 0x0f, 0x10, 0x44,
       0x24, 0xf4, 0xf3, 0x0f, 0x5a, 0xc0, 0xf2, 0x0f, 0x11, 0x44, 0x24, 0xf8,
       0x48, 0x8b, 0x44, 0x24, 0xf8, 0x48, 0x89, 0x85, 0x00, 0x00, 0x00, 0x00,
    };
    copy_block(op_load_single_FD_T1_0_code, 95);
    *(uint64_t *)(code_ptr() + 30) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 47) = (uint64_t)(uintptr)gKernelData;
    *(uint32_t *)(code_ptr() + 91) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(95);
}
#endif
...
#define HAVE_gen_op_load_double_FD_T1_T2
{
    ...
    copy_block(op_load_double_FD_T1_T2_code, 73);
    *(uint64_t *)(code_ptr() + 31) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 48) = (uint64_t)(uintptr)gKernelData;
    *(uint32_t *)(code_ptr() + 69) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(73);
}
#endif
...
#define HAVE_gen_op_load_double_FD_T1_im
{
    ...
    copy_block(op_load_double_FD_T1_im_code, 81);
    *(uint64_t *)(code_ptr() + 39) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 56) = (uint64_t)(uintptr)gKernelData;
    *(uint32_t *)(code_ptr() + 6) = (int32_t)((long)param1 - (long)(code_ptr() + 6 + 4)) + 0;
    *(uint32_t *)(code_ptr() + 77) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(81);
}
#endif
...
#define HAVE_gen_op_load_single_FD_T1_T2
{
    ...
    copy_block(op_load_single_FD_T1_T2_code, 96);
    *(uint64_t *)(code_ptr() + 31) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 48) = (uint64_t)(uintptr)gKernelData;
    *(uint32_t *)(code_ptr() + 92) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(96);
}
#endif
...
#define HAVE_gen_op_load_single_FD_T1_im
{
    ...
    copy_block(op_load_single_FD_T1_im_code, 104);
    *(uint64_t *)(code_ptr() + 39) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 56) = (uint64_t)(uintptr)gKernelData;
    *(uint32_t *)(code_ptr() + 6) = (int32_t)((long)param1 - (long)(code_ptr() + 6 + 4)) + 0;
    *(uint32_t *)(code_ptr() + 100) = (uint32_t)((uintptr)&reg_F3 - (uintptr)cpu());
    inc_code_ptr(104);
}
#endif
...
#define HAVE_gen_op_store_double_F0_T1_0
{
    ...
    copy_block(op_store_double_F0_T1_0_code, 70);
    *(uint64_t *)(code_ptr() + 37) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 55) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(70);
}
#endif
...
#define HAVE_gen_op_store_single_F0_T1_0
{
    ...
    copy_block(op_store_single_F0_T1_0_code, 141);
    *(uint64_t *)(code_ptr() + 110) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 127) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(141);
}
...
#define HAVE_gen_op_store_double_F0_T1_T2
{
    ...
    copy_block(op_store_double_F0_T1_T2_code, 71);
    *(uint64_t *)(code_ptr() + 38) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 56) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(71);
}
...
#define HAVE_gen_op_store_double_F0_T1_im
{
    ...
    copy_block(op_store_double_F0_T1_im_code, 79);
    *(uint64_t *)(code_ptr() + 46) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 64) = (uint64_t)(uintptr)gKernelData;
...
#define HAVE_gen_op_store_single_F0_T1_T2
{
    ...
    copy_block(op_store_single_F0_T1_T2_code, 144);
        *(uint64_t *)(code_ptr() + 113) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 130) = (uint64_t)(uintptr)gKernelData;
    inc_code_ptr(144);
}
#endif
...
#define HAVE_gen_op_store_single_F0_T1_im
{
    ...
    copy_block(op_store_single_F0_T1_im_code, 150);
    *(uint64_t *)(code_ptr() + 119) = (uint64_t)VMBaseDiff;
    *(uint64_t *)(code_ptr() + 136) = (uint64_t)(uintptr)gKernelData;
